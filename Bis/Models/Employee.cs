namespace Bis.Models
{
    ...
    public partial class Employee
    {
        ...
        [StringLength(50)]
        public string reforerecePersonForBis { get; set; }
        [StringLength(50)]
        public string preveiousComapnyReforerece { get; set; }
        [StringLength(50)]
        public string reforerecePersonContactnumber { get; set; }
        [StringLength(50)]
        public string reforerecePersonDesination { get; set; }
        [StringLength(50)]
        public string collegeHodName { get; set; }
        public string collegeHodContactNumber { get; set; }
        [StringLength(50)]
        public string NDTcertificateExpairyDate { get; set; }
        [StringLength(50)]
