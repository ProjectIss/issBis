...
namespace Bis.Controllers
{
    ...
    public class ChargesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,locationId,companyId,employeeStayCharge,employeeVisitCharge,companyStayCharge,companyVisitCharge,employeeClaimCharges,companyClaimCharges,remark,categoryId")] Charge charge)
        {
            ...
            ViewBag.categoryId = new SelectList(db.Categories, "id", "name", charge.categoryId);
            return View(charge);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,locationId,companyId,employeeStayCharge,employeeVisitCharge,companyStayCharge,companyVisitCharge,employeeClaimCharges,companyClaimCharges,remark,categoryId")] Charge charge)
        {
            if (ModelState.IsValid)
            {
