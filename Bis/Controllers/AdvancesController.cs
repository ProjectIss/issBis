...
namespace Bis.Controllers
{
    ...
    public class AdvancesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,employeeId,date,amount,reason")] Advance advance)
        {
            ...
            ViewBag.employeeId = new SelectList(employees, "Value", "Text", advance.employeeId);
            return View(advance);
        }
        ...
        public ActionResult Edit([Bind(Include = "id,employeeId,date,amount,reason")] Advance advance)
        {
            ...
            ViewBag.employeeId = new SelectList(employees, "Value", "Text", advance.employeeId); ViewBag.employeeId = new SelectList(db.Employees, "id", "employeeId", advance.employeeId);
            return View(advance);
        }
